...
export default function AdminProfileCard({ user, onProfileClick }) {
  ...
  return (
    <div className="relative bg-stone-50 dark:bg-gray-900 rounded-2xl p-6 flex flex-col items-center text-center transform transition-transform duration-300 hover:scale-105">
      <button
        onClick={toggleTheme}
